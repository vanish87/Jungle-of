...
namespace Jungle
{
	GamingScene3::GamingScene3(void)
	{
	}
	...
	void GamingScene3::keyPressed( int key )
	{
	...
	void GamingScene3::keyReleased( int key )
	{
	}

	void GamingScene3::inPose( ofxUser & user )
	{
		cout << "INPOSE : " ;
		cout<<user.pose<<endl;
		if(user.pose == "TREE")
	...
	void GamingScene3::inGesture( ofxUser & user )
	{
	}

	void GamingScene3::userIn( ofxUser & user )
	{
	}

	void GamingScene3::userMove( ofxUser & user )
	{
	}

	void GamingScene3::userOut( ofxUser & user )
	{
	}
